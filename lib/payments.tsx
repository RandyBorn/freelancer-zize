...
export const PAYMENT_LINKS = {
  onePagerDeposit: "https://www.paypal.me/DEINNAME/249.50",
  bugBusterFull: "https://www.paypal.me/DEINNAME/199",
  mvpDeposit: "https://www.paypal.me/DEINNAME/645",
};

export const CONTACT_EMAIL = "Randyborn677@yahoo.com";
...
function Card({ title, price, children, ctaLabel, href }: CardProps) {
  return (
